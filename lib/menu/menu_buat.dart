          ...
          children: <Widget>[
            ...
            SleekButton(
              ...
              setState(() {
                ...
                _judul.clear();
                _deskripsi.clear();
                Route route = MaterialPageRoute(builder: (context) => menu_catatan());
...
class menu_buat extends StatelessWidget{
  final _judul = TextEditingController();
  final _deskripsi = TextEditingController();
    ...
    getData(){
        ...
        if(index != null && value != null){
            setState(() {
                ...
                deskripsiController.text = value['deskripsi'];
            });
        }
    }
 
    // proses menyimpan data yang diinput user ke Shared Preferences
    saveData(Type menu_catatan) async {
        // cek semua data sudah diisi atau belum
